...
import PrescriptionsDataTable from "@/components/admin/prescriptions-page/prescriptions-table/prescriptions-data-table";
import {columns} from "@/components/admin/prescriptions-page/prescriptions-table/columns";
import AddPrescriptionModal from "@/components/admin/prescriptions-page/prescriptions-actions/add-prescription-modal";
...
const AdminPrescriptionsPage = () => {
  ...
  function handleAddNewPrescription() {
    setIsModalOpen(true)
  }
  ...
  return ( 
    <div className="py-10">
      <div className="py-8 flex items-center justify-between">
        <h1 className="font-medium text-2xl xl:text-[42px]">Prescriptions Overview</h1>
        <div className="flex gap-2 items-center">
          <button onClick={handleAddNewPrescription} className="inline-flex items-center gap-2 text-[16px] bg-black text-white dark:bg-white dark:text-black hover:bg-black/65 dark:hover:bg-white/90 transition-colors duration-500 max-sm:py-2 sm:py-4 px-3 rounded-full">
      ...
      <PrescriptionsDataTable columns={columns} data={prescriptions.data}/>
      <AddPrescriptionModal isOpen={isModalOpen} onClose={handleCloseModal}/>
    </div>
   );
}
