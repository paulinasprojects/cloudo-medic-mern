    ...
    <div className="py-10">
      <div className="py-8 flex items-center justify-between">
        ...
        <div className="flex gap-2 items-center">
          <button className="inline-flex items-center gap-2 text-[16px] bg-black text-white dark:bg-white dark:text-black hover:bg-black dark:hover:bg-white/90 transition-colors max-sm:py-2 sm:py-4 px-3 rounded-full">
