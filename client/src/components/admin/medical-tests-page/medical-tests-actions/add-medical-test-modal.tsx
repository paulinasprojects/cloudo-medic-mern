...
import AddMedicalTestForm from "./add-medical-test-form";
    ...
    >
      <div className="bg-white dark:bg-black rounded-sm border border-slate-800 w-full max-w-xl">
        <div className="flex items-center justify-between px-4 py-5">
          <h2 className="text-lg font-bold text-gray-500">Add New Medical Test</h2>
        ...
        <AddMedicalTestForm onSuccess={handleClose}/>
      </div>
    </div>
  )
}
