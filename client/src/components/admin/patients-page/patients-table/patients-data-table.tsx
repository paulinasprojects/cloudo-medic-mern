...
export default function PatientsDataTable<TData, TValue>({
  columns,
  data
  ...
  return (
		<div>
			<div className="flex items-center py-4">
				<input 
					type="text"
					placeholder="Find by alergies"
					value={(table.getColumn("allergies")?.getFilterValue() as string) ?? ""}
					onChange={(event) => table.getColumn("allergies")?.setFilterValue(event.target.value)}
