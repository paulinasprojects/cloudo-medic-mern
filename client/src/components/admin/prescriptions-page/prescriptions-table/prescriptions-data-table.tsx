...
export default function PrescriptionsDataTable<TData, TValue>({
  columns,
  data
  ...
  return (
    <div>
      <div className="flex items-center py-4">
        <input 
          type="text" 
          placeholder="Find by medication"
          value={(table.getColumn("medication")?.getFilterValue() as string) ?? ""}
          onChange={(event) => table.getColumn("medication")?.setFilterValue(event.target.value)}
